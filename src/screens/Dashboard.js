                        ...
                        <div class="mt-5 overflow-y-auto">
                            <nav class="px-2 space-y-1">
                                ...
                                >
                                    {/* <!-- Heroicon name: home --> */}
                                    <svg
                                        class="mr-4 h-6 w-6 text-teal-200 transition ease-in-out duration-150"
                                        fill="none"
                                        viewBox="0 0 24 24"
                                        stroke="currentColor"
                                    >
                        ...
                        <div class="mt-6 flex-1 h-0 overflow-y-auto">
                            <nav class="px-2 space-y-1">
                                ...
                                >
                                    {/* <!-- Heroicon name: cog --> */}
                                    <svg
                                        class="mr-4 h-6 w-6 text-teal-200 group-hover:text-teal-200 group-focus:text-teal-200 transition ease-in-out duration-150"
                                        fill="none"
                                        viewBox="0 0 24 24"
                                        stroke="currentColor"
                                    >
                                ...
                                >
                                    ...
                                    <svg
                                        class="mr-4 h-6 w-6 text-teal-300 group-hover:text-teal-200 group-focus:text-teal-200 transition ease-in-out duration-150"
                                        fill="none"
                                        viewBox="0 0 24 24"
                                        stroke="currentColor"
                                    >
